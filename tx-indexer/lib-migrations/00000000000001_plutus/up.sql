...
CREATE DOMAIN CARDANO.HASH28 AS
    BYTEA CHECK (LENGTH(VALUE) = 28);

CREATE DOMAIN CARDANO.HASH32 AS
    BYTEA CHECK (LENGTH(VALUE) = 32);

CREATE DOMAIN CARDANO.SLOT AS BIGINT;

CREATE DOMAIN CARDANO.BLOCK_HASH AS CARDANO.HASH32;
...
CREATE DOMAIN PLUTUS.TRANSACTION_HASH AS CARDANO.HASH32;

CREATE DOMAIN PLUTUS.ED25519_PUB_KEY_HASH AS CARDANO.HASH28;

CREATE DOMAIN PLUTUS.SCRIPT_HASH AS CARDANO.HASH28;

CREATE DOMAIN PLUTUS.DATUM_HASH AS CARDANO.HASH32;
