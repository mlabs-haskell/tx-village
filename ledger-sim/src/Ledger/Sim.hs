module Ledger.Sim (LedgerSim, LedgerState (..), LedgerConfig (..), LedgerValidatorError (..), submitTx) where
...
import Ledger.Sim.Types.Slot (Slot (Slot, getSlot), SlotConfig (SlotConfig, sc'slotLength), slotToPOSIXTimeRange)
