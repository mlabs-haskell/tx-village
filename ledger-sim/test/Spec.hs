        ...
        ledgerSucceeds @() $ do
          ...
          void . submitTx $
            TxInfo
              ...
              [ownPubKeyHash]
              (AssocMap.safeFromList [(Minting cs, Redeemer (toBuiltinData @Integer 1234))])
              AssocMap.empty
              dummyTxId
        ...
        ledgerSucceeds $ do
          ...
          void . submitTx $
            TxInfo
              ...
              (intervalValidRange currentTime (currentTime' + 1))
              [ownPubKeyHash]
              (AssocMap.safeFromList [(Spending newUTxORef, Redeemer $ toBuiltinData ())])
              (AssocMap.safeFromList [(datumHash, datum)])
              dummyTxId
        ...
        let ref = TxOutRef dummyTxId' 1
         in ledgerFailsBy @()
              ...
              $ TxInfo
                ...
                IV.always
                [ownPubKeyHash]
                (AssocMap.safeFromList [(Spending ref, Redeemer $ toBuiltinData ())])
                AssocMap.empty
                dummyTxId
         ...
         in
          ledgerFailsBy @()
            ...
            $ TxInfo
              ...
              IV.always
              [ownPubKeyHash]
              (AssocMap.safeFromList [(Minting invalidCurrencySymbol, Redeemer (toBuiltinData @Integer 1234))])
              AssocMap.empty
              dummyTxId
