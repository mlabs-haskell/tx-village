...
import Ledger.Sim.Types.LedgerConfig (LedgerConfig, ScriptMode (ScriptMode'Unchecked), mkLedgerConfig)
...
main = do
  ...
  ledgerCfg <- either throwIO pure $ mkLedgerConfig (M.fromList [(sh, (ScriptMode'Unchecked, script))]) testCostModel Nothing ()
